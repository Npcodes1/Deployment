// In the data.js file, before the title key, add a new key of id and a number from 1-12 for all of the books (so an id: 1 would be for Fun Home, id: 2 for Watchmen, etc....)
